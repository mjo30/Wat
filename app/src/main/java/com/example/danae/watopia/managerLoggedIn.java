...
import android.view.MenuInflater;
     ...
     */
public class managerLoggedIn extends AppCompatActivity {
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /**
     * This method is called when users with manager standing log into their account
    ...
    public boolean onOptionsItemSelected(android.view.MenuItem item) {
        switch (item.getItemId()) {
            case R.id.add1:
                startActivity(new Intent(managerLoggedIn.this, Report.class));
                break;
            case R.id.add2:
                startActivity(new Intent(managerLoggedIn.this, qualityReport.class));
                break;
            case R.id.view1:
                startActivity(new Intent(managerLoggedIn.this, ViewReport.class));
                break;
            case R.id.view2:
                startActivity(new Intent(managerLoggedIn.this, viewPurity.class));
                break;
            case R.id.profile:
                startActivity(new Intent(managerLoggedIn.this, LoggedIn.class));
                break;
            case R.id.logout:
                startActivity(new Intent(managerLoggedIn.this, LoginActivityPage.class));
                break;
            default:
                break;
        }
